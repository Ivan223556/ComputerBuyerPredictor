...
public class TestRunner {
    public static void main(String[] args) {
            ...
            System.err.println(predictor.predict(0, 1, 1));//4
            System.err.println(predictor.predict(1, 0, 0));
            System.out.println(predictor.predict(1, 0, 1));
            System.out.println(predictor.predict(1, 1, 0));//7
            System.out.println(predictor.predict(1, 1, 1));
            System.out.println(predictor.predict(2, 0, 0));
            System.out.println(predictor.predict(2, 0, 1));//10
